...
export const englishNotes: Note = {
  ...
  content: `<h1>English Study Notes</h1>
        ...
        <ul>
            ...
            <li>Adverb: modifies a verb, adjective, or another adverb (e.g., quickly)</li>
        ...
        <ul>
            ...
            <li>Compound Sentence: two independent clauses joined by conjunction</li>
...
export const historyNotes: Note = {
  ...
  content: ` 
        ...
        <ul>
            ...
            <li>Helps us understand how societies, cultures, and governments developed.</li>
...
export const scienceNotes: Note = {
  ...
  content: ` 
        ...
        <ul>
            ...
            <li>Law of Conservation of Mass: matter is not created or destroyed.</li>
        </ul>
