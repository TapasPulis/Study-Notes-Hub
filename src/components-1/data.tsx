    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            Adverb: modifies a verb, adjective, or another adverb (e.g.,
            quickly)
          </li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            Mesopotamia: First civilization; invented writing (cuneiform).
          </li>
          <li>
          ...
          <li>
            Ancient Greece: Birthplace of democracy, philosophy, Olympics.
          </li>
